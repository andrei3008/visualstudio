...
export default function HeroSoftwareCustomFirme({ stats }: Props) {
  return (
    <>
                  ...
                  <div className="mxd-block__content">
                    <div className="mxd-block__inner-headline">
                      ...
                      <p className="inner-headline__text t-large t-bright loading__item">
                        Construim aplicații și platforme interne care funcționează exact cum ai nevoie — fără limitări, fără funcții inutile.
                      </p>
